...
console.log("Also configure Email Routing for notetaker@minutes.bot and custom domains for app.minutes.bot plus the meeting bot host.");
console.log("The main Worker custom domain is app.minutes.bot; keep the meeting bot on a separate host such as meeting-bot.company.com.");
