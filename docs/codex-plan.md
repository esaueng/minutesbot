...
9. Implement fetch-based meeting bot REST client, typed errors, delete_data, and webhook signature verification.
10. Implement meeting bot webhook endpoint with signature verification, idempotency, state updates, transcript segment storage, and transcript fetch queueing.
