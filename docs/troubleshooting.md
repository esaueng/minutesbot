...
- Meeting bot auth failed: verify `BOT_API_KEY` with `wrangler secret put`.
...
- Webhook signature invalid: ensure the base64 webhook secret matches `BOT_WEBHOOK_SECRET`.
