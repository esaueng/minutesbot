...
describe("summary engine", () => {
  ...
  it("includes the selected meeting type and strict schema requirements in the summary prompt", () => {
    ...
    expect(prompt).toContain("Microsoft Teams-style AI meeting recap");
    expect(prompt).toContain("Generated by AI. Be sure to check for accuracy.");
    expect(prompt).toContain("Do not copy this example content unless it appears in the transcript.");
